            ...
            <div>
                    <div className="container mt-2">
                        <div className="row">
                           ...
                           {
                            Details[0]['discount'] ? (
                                <span><strike className="text-secondary">Price:{Details[0]['price']}</strike> discountPrice:{Details[0]['price']}</span>
                            ...
                            <div className="row">
                                ...
                                <div className="col-4 p-2"><button className="btn w-100 btn-success">Add to Cart</button></div>
                                <div className="col-4 p-2"><button className="btn w-100 btn-success">Add to Wish</button></div>
                            </div>
                            </div>
                        </div>
                        ...
                        <div className="row mt-3">
                            ...
                            <div className="tab-pane fade show active" id="Speci-tab-pane" role="tabpanel" aria-labelledby="Speci-tab" tabIndex="0"></div>
