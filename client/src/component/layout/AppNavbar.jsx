...
import SubmitButton from '../uaer/UserSubmitButton'
        ...
        <div className="container">
          <div className="row justify-content-around">
            <div className="col-md-6">
              <span>
                <span className="f-12 fw-bolder ">
                  <i className="bi bi-envelope"></i> aminboni048@gmail.com
                </span>
                <span className="f-12 mx-2 fw-bolder fs-6">
                  <i className="bi bi-envelope"></i> 01733427955
                </span>
              </span>
            </div>
            <div className="col-md-6">
